...
2003 年创立 2005 年被谷歌收购 2008 年 HTC G1 第一款安卓手机
...
.. figure:: /mobile/images/license.jpg
   :alt: 
...
有，总比没有强，还有其他系统级别的签名——OTA 升级，某些设备的 LKM
权限管理是什么？
...
-  眼耳鼻肤口，5 个 Sensor，但输出 6
   种感觉（加速度），\ ``onXXXSensorChanged callback``
   函数在大脑中，每个人都可以随时自定义 ``callback`` 函数内容
-  ``ContentProvider`` 记忆
...
-  使用\ ``Bootloader`` 替换 ``Recovery`` 之后，刷入 ``su`` /
   ``deamon-su``
...
.. figure:: /mobile/images/new-platform.jpg
   :alt: 
