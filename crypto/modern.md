...
* 用私钥解密
  ...
  ```shell
  openssl rsautl -decrypt -in flag.enc -inkey private.pem -out ok.txt
  ```
...
![base64 编码表](/crypto/images/base64.png)

* 范例

  编码 `Man`

  ![base64 编码 MAN](/crypto/images/base64_man.png)
...
![base64 补 0](/crypto/images/base64_0.png)
