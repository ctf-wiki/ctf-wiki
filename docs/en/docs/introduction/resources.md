# Learning Resource
!!! warning
    Most of the resources in current page are mainly China website (may unaccessible for oversea) or its languague is Chinese

    If you know any global website may help to include it: [Contributing](https://ctf-wiki.org/en/contribute/before-contributing/).
