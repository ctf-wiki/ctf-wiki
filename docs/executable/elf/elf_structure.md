...
![](/executable/elf/figure/elf-layout.png)
...
![img](/executable/elf/figure/relocatable_fields.png)

其中，word32 指定了一个 32 比特的变量，占用 4 个字节，对齐方式任意。这些值使用和 Intel 架构中其它字类似的字节序，一般都是小端序。

![img](/executable/elf/figure/word32.png)
...
![img](/executable/elf/figure/got.png)
