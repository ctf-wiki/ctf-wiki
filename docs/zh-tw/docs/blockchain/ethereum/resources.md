...
## Books
- 《以太坊技術詳解與實戰》-- 以太坊創始人、首席科學家 Vitalik Buterin 傾力推薦
- 待補充

## papers
- 智能合約 [https://github.com/hzysvilla/Academic_Smart_Contract_Papers](https://github.com/hzysvilla/Academic_Smart_Contract_Papers)
- 區塊鏈（包括智能合約）[https://github.com/jianyu-niu/blockchain_conference_paper](https://github.com/jianyu-niu/blockchain_conference_paper)
- 待補充

## Security Tools

> 搬運自 [https://consensys.github.io/smart-contract-best-practices/security_tools/](https://consensys.github.io/smart-contract-best-practices/security_tools/)
