...
> Note: The `ctfwiki/ctf-wiki` on DockerHub is out of date, but you can manually build the version after using `mkdocs-material-insiders` using the following command

```
# docker run -d --name=ctf-wiki -p 4100:80 ctfwiki/ctf-wiki
git clone https://github.com/ctf-wiki/ctf-wiki.git --depth=1
