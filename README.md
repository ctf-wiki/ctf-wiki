...
本项目主要使用issue与bearychat进行交流沟通。berrychat的团队名为 `ctf-wiki`，欢迎申请加入（申请时请注明申请理由）。

#### 文档协作

本文档仅有master分支，通过fork和PR的方式更新文档。基本流程如下
1. fork主仓库到自己的仓库中。
2. 当你想要贡献某部分内容时，请你务必仔细查看issue与Project中对应的看板，确定是否有人已经开始了这项工作，最好可以加入berrychat中的ctf-wiki团队，方便沟通与交流。
